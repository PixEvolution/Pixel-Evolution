...
/** @type {string} */
const CACHE_VERSION = '1739769686|6897808504';
/** @type {string} */
const CACHE_PREFIX = 'Pixel Evolution-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Pixel Evolution.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Pixel Evolution.html","Pixel Evolution.js","Pixel Evolution.offline.html","Pixel Evolution.icon.png","Pixel Evolution.apple-touch-icon.png","Pixel Evolution.worker.js","Pixel Evolution.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["Pixel Evolution.wasm","Pixel Evolution.pck"];
